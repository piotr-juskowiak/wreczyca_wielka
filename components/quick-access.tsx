          ...
          {services.map((service) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative flex items-center gap-5 rounded-[2.5rem] bg-white p-6 shadow-2xl shadow-[#344e41]/5 border border-white transition-all hover:border-[#a3b18a]/50 text-left overflow-hidden"
              >
