  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-xl">
        ...
        <p
          className={`mt-3 text-[#cbd5e1]/80 leading-relaxed font-medium ${
        ...
        <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-4 sm:justify-between">
          ...
          <div className="flex items-center gap-3 text-[9px] font-bold uppercase tracking-widest text-[#cbd5e1]/60">
