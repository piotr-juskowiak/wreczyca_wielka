  ...
  return (
    <div className="fixed bottom-8 right-8 z-40 select-none">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="group flex h-14 items-center gap-3 rounded-full bg-digital-blue/85 backdrop-blur-md px-4 text-white shadow-xl hover:bg-digital-blue border border-white/20 transition-all duration-300"
      >
