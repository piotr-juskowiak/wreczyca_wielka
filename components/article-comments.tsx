...
const AVATAR_PALETTES = [
  "bg-[#656d4a]/20 text-[#0f172a]",
  "bg-[#a4ac86]/20 text-[#414833]",
  "bg-[#cbd5e1]/45 text-[#414833]",
  "bg-[#414833]/15 text-[#414833]",
  ...
  return (
    <div className="mt-20 border-t border-[#cbd5e1]/40 pt-16 select-none">
      ...
      <div className="flex items-center gap-3.5 mb-10 pb-3 border-b border-[#cbd5e1]/35">
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#414833]/10 text-[#414833]">
        ...
        <div>
          ...
          <span className="text-[10px] text-[#a4ac86] font-bold uppercase tracking-wider block">
        ...
        <div className="lg:col-span-7 space-y-6">
          <AnimatePresence mode="popLayout" initial={false}>
            {comments.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[10px] font-bold text-[#414833]/30 flex items-center gap-1">
                        <Calendar className="h-3 w-3" /> {com.time}
                      </span>
                    </div>
                    <p className="text-sm text-[#414833]/75 font-medium leading-relaxed">
                      {com.comment}
                    </p>
                  </div>
                </motion.div>
              ...
              >
                <MessageSquare className="h-10 w-10 text-[#a4ac86]/40 mb-3" />
                <p className="text-sm font-bold text-[#0f172a] mb-1">Brak komentarzy</p>
                <p className="text-xs text-[#414833]/50 max-w-xs font-medium leading-relaxed">
        ...
        <div className="lg:col-span-5">
          <div className="bg-white border border-[#cbd5e1]/40 rounded-[2rem] p-6 shadow-sm">
            <h4 className="text-xs font-black uppercase tracking-widest text-[#0f172a] mb-5 flex items-center gap-2">
              <Send className="h-3.5 w-3.5 text-[#a4ac86]" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <User className="absolute left-4 h-4 w-4 text-[#a4ac86] pointer-events-none" />
                  <input
                    id="comment-author"
                    type="text"
                    required
                    ...
                    className="w-full bg-[#f1f5f9]/45 border border-[#cbd5e1]/40 text-xs font-semibold text-[#0f172a] rounded-2xl pl-11 pr-4 py-3.5 outline-none focus:border-[#414833] focus:bg-white transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-[#f1f5f9]/45 border border-[#cbd5e1]/40 text-xs font-semibold text-[#0f172a] rounded-2xl p-4 outline-none focus:border-[#414833] focus:bg-white transition-all resize-none leading-relaxed"
                />
              </div>

              <div className="flex items-start gap-2 bg-[#f1f5f9]/30 p-3 rounded-2xl border border-[#cbd5e1]/20">
                <AlertCircle className="h-3.5 w-3.5 text-[#a4ac86] shrink-0 mt-0.5" />
                <p className="text-[9px] font-medium text-[#414833]/65 leading-relaxed">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 rounded-2xl bg-[#414833] hover:bg-[#0b5e28] text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-[#414833]/15 hover:shadow-[#414833]/25 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
